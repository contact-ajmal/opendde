...
import { Crosshair, FlaskConical, Box, Beaker, Sparkles, BarChart3, Search, TrendingUp, Play, Pause, ChevronLeft, ChevronRight, Github, Zap, ListChecks } from 'lucide-react';
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-muted">
                <li>
                  <a href="https://github.com/contact-ajmal/opendde" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                    GitHub Repository
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/ajmalnazirbaba/" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                    Contact (LinkedIn)
                  </a>
                </li>
                <li>
          ...
          <div className="mt-12 flex flex-col items-center gap-3 border-t border-[var(--border)] pt-6 sm:flex-row sm:justify-between">
            <p className="text-xs text-muted-2">
              Built with ❤️ by <a href="https://www.linkedin.com/in/ajmalnazirbaba/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors">Ajmal</a> &middot; &copy; 2026 OpenDDE &mdash; MIT License
            </p>
